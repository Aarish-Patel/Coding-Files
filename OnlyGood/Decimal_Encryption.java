import java.util.*;
class Decimal_Encryption
{
    String Encrypted_String, Decrypted_String, Message1, Message2, Message3;
    ...
    void Decimal_main(String input, int rkey, char auto)
    {
        ...
        System.out.println("Decimal : " + Encrypted_String);
