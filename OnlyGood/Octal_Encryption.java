import java.util.*;
class Octal_Encryption
{
    String Encrypted_String, Decrypted_String, public_key, Message1, Message2, Message3 = "Processing The String.....";
    ...
    void Octal_main(String input, int rkey, char auto)
    {
        ...
        System.out.println("Octal : " + Encrypted_String);
